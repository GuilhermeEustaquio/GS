...
- **Fluxo central:** autenticação simples, cadastro de objetivos e habilidades, comparação com requisitos das vagas e sugestões de trilhas.
- **Contexto:** protótipo desenvolvido para a disciplina **Front-End Design Engineering (FIAP)**.

## 🧭 Páginas e recursos principais
- `index.html`: landing page com resumo do problema, proposta TechMatch e call-to-action para iniciar o match.
- `match.html`: painel da candidata para registrar habilidades, ver cards de match e lacunas.
- `match-empresas.html`: painel para empresas cadastrarem vagas e requisitos prioritários.
